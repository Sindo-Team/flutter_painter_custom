...
class _ObjectViewWidget extends StatefulWidget {
  /// Child widget.
  final Widget child;
  ...
  @override
  _ObjectViewWidgetState createState() => _ObjectViewWidgetState();
}

class _ObjectViewWidgetState extends State<_ObjectViewWidget> {
...
class _ObjectViewControlBox extends StatelessWidget {
  ...
  /// Creates an [_ObjectViewControlBox] with the given [shape] and [active].
  ///
  /// By default, it will be a [BoxShape.rectangle] shape and not active.
  const _ObjectViewControlBox({
    Key? key,
